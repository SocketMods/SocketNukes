...
public class ExtendedExplosionType extends ForgeRegistryEntry<ExtendedExplosionType> {
    ...
    public List<Block> getImmuneBlocks() {
        return immuneBlocks;
    }

    public void setImmuneBlocks(List<Block> blocks) {
        this.immuneBlocks = blocks;
    }
    ...
    public boolean getDoBlocksDrop() {
        return doBlocksDrop;
    }

    public void setDoBlocksDrop(boolean newBlocksDrop) {
        this.doBlocksDrop = newBlocksDrop;
    }

    public int getExplosionStages() {
        return explosionStages;
    }

    public void setExplosionStages(int stages) {
        this.explosionStages = stages;
    }

    public ExplosionProperties getProperties() {
        return properties;
    }
    ...
    public void setFuseTime(int newFuseTime) {
