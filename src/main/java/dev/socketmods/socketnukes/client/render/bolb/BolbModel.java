...
public class BolbModel extends ListModel<BolbEntity> {
    protected final ModelPart slimeBodies;
    protected final ModelPart slimeRightEye;
    protected final ModelPart slimeLeftEye;
    protected final ModelPart slimeMouth;
    protected final ModelPart slimeHat1;
    protected final ModelPart slimeHat2;
    protected final ModelPart slimeHatBase;
